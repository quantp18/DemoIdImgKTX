package com.example.demoidimgktx.custom_view.grid;

import android.graphics.RectF;

import com.example.demoidimgktx.custom_view.layer.slant.SlantCollageLayout;
import com.example.demoidimgktx.custom_view.layer.straight.StraightCollageLayout;
            ...
            quShotLayout = new StraightCollageLayout() {
                ...
                public void layout() {
                    ...
                    for (int i2 = 0; i2 < size; i2++) {
                        QueShotLayout.Step step = info.steps.get(i2);
                        switch (step.type) {
                            case 0:
            ...
            quShotLayout = new SlantCollageLayout() {
                ...
                public void layout() {
                    ...
                    for (int i = 0; i < size; i++) {
                        QueShotLayout.Step step = info.steps.get(i);
                        switch (step.type) {
                            case 0:
